...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-md-12">
            ...
            <asp:ListView ID="ProductsListView" runat="server" DataSourceID="ProductDataSource" DataKeyNames="ProductID" ItemType="WestWindSystem.Entities.Product" InsertItemPosition="LastItem">
                <EditItemTemplate>
                    <tr style="">
                        <td>
